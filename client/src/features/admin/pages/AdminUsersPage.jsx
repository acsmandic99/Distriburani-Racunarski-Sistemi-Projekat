...
import { downloadAdminReport } from "../services/adminAPI.js";
...
const UsersManagementPage = () => {
  ...
  const handleDownloadReport = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute("download", "izvestaj_top_autori.pdf");
  ...
  if (loading)
    return <p style={{ padding: "2rem" }}>Učitavanje korisnika...</p>;
  ...
  return (
    <div style={{ padding: "2rem", color: "black" }}>
      ...
      <button onClick={handleDownloadReport}>Generiši PDF Izveštaj</button>
              ...
              >
                <td style={{ padding: "12px" }}>
                  <img
                    src={
                      u.profile_picture ||
                      "/static/uploads/profile-images/default-avatar.jpg"
                    }
                    alt="avatar"
                    style={{
                      width: "40px",
